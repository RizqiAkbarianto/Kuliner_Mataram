		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
				...
				<div class="flex-sb-m flex-w p-b-35">
					<div class="flex-w">
						<a href=" <?php echo base_url('produk/tambah') ?> " class="btn btn-outline-secondary "><i class="fa fa-plus"> Tambah produk</i></a>
					</div>
								...
								<div class="block2-img wrap-pic-w of-hidden pos-relative ">
									...
									<div class="block2-overlay trans-0-4">
										...
										<div class="block2-btn-addcart w-size1 trans-0-4">
											<!-- Button -->
											<a href="<?php echo base_url('produk/gambar/' .$produk->id_produk) ?>" type="" value="" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
												<i class="fa fa-plus"> Gambar</i>
											</a><br>
											<a href="<?php echo base_url('produk/edit/'.$produk->id_produk) ?>" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
												<i class="fa fa-edit"> Edit</i>
											</a><br>
											<a href="<?php echo base_url('produk/delete/'.$produk->id_produk) ?>" onclick="return confirm('Yakin anda ingin menghapus data ini ?')" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
