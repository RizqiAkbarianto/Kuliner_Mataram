...
<!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-light-navy elevation-4">
    ...
    <a href="<?= base_url() ?>assets/admin3/index3.html" class="brand-link">
      <img src="<?= base_url() ?>assets/upload/image/Picture1.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin/promosi')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>DATA PROMOSI</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin/promosi/tambah')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>TAMBAH PROMOSI</p>
                </a>
              </li>
