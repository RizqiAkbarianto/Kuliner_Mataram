 ...
 // Form Open
 						echo form_open_multipart(base_url('admin/promosi/tambah'),' class="form-horizontal"');
 						...
 						<div class="form-group row">
 							...
 							<div class="col-sm-10">
 								<input type="text" name="nama_promosi" class="form-control"  placeholder="Nama Promosi" value="<?php echo set_value('nama_promosi') ?>" required> 
 							</div>
 						</div>
 						...
 						<div class="form-group row ">
 							...
 							<div class="col-sm-10">
 								<input type="text" name="kode_promosi" class="form-control"  placeholder="Kode Promosi" value="<?php echo set_value('kode_promosi') ?>" required> 
 							</div>
 						</div>
...
<!-- 
 						<div class="form-group row">
 							...
 							<div class="col-sm-10">
 								<input type="number" name="harga" class="form-control"  placeholder="Harga Promosi" value="<?php echo set_value('harga') ?>" required> 
 							</div>
 						</div> -->
 						...
 						<!-- <div class="form-group row">
 							...
 							<div class="col-sm-10">
 								<input type="number" name="stok" class="form-control"  placeholder="Stok Promosi" value="<?php echo set_value('stok') ?>" required> 
 							</div>
 						</div> -->
 						...
 						<!-- <div class="form-group row">
 							...
 							<div class="col-sm-10">
 								<input type="text" name="berat" class="form-control"  placeholder="Berat Promosi" value="<?php echo set_value('berat') ?>" required> 
 							</div>
 						</div>
 						...
 						<div class="form-group row">
 							...
 							<div class="col-sm-10">
 								<input type="text" name="ukuran" class="form-control"  placeholder="Ukuran Promosi" value="<?php echo set_value('ukuran') ?>" required> 
 							</div>
 						</div> -->
